          ...
          <div class="LoginFormInnerContainer">
            ...
            <form action="{{route('regist')}}" method="post" enctype="multipart/form-data">
              ...
              <div class="inputContainer">
                <label class="label" for="emailAddress"><img src="https://i.imgur.com/Hn13wvm.png" class="labelIcon"><span>Nama*</span></label>
                <input type="text" class="input" id="empId" placeholder="Enter your Username" name="nama">
              </div>
              <div class="inputContainer">
                <label class="label" for="emailAddress"><img src="https://i.imgur.com/Hn13wvm.png" class="labelIcon"><span>Level*</span></label>
                <input type="text" class="input" id="empId" placeholder="Enter your Username" name="level">
              </div>
              <div class="inputContainer">
                <label class="label" for="emailAddress"><img src="https://i.imgur.com/Hn13wvm.png" class="labelIcon"><span>Foto*</span></label>
                <input type="file" name="foto">
              </div>
              <div class="inputContainer">
                <label class="label" for="emailAddress"><img src="https://i.imgur.com/Hn13wvm.png" class="labelIcon"><span>Username*</span></label>
                <input type="text" class="input" id="empId" placeholder="Enter your Username" name="username">
              </div>
              <div class="inputContainer">
